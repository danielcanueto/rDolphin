...
```
type_analysis_plot(quantification_variables$final_output$quantification,quantification_variables$final_output,imported_data,imported_data$ROI_data,'boxplot')
```
...
```
type_analysis_plot(quantification_variables$final_output$quantification,quantification_variables$final_output,imported_data,imported_data$ROI_data,'pca')
```
...
```
type_analysis_plot(quantification_variables$final_output$quantification,quantification_variables$final_output,imported_data,imported_data$ROI_data,'dendrogram_heatmap')
