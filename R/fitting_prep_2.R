...
fitting_prep_2 = function(Xdata,Ydata,initial_fit_parameters,program_parameters,created_baseline) {
  ...
  if (BGSigNum>0) {
    ...
    FeaturesMatrix[(signals_to_fit + 1):nrow(FeaturesMatrix),1]=0.5*FeaturesMatrix[(signals_to_fit + 1):nrow(FeaturesMatrix),2]
