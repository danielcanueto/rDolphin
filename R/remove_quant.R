...
final_output$quantification[ind1,ind2]=final_output$chemical_shift[ind1,ind2]=final_output$quantification[ind1,ind2]=final_output$half_bandwidth[ind1,ind2]=final_output$signal_area_ratio[ind1,ind2]=final_output$fitting_error[ind1,ind2]=final_output$intensity[ind1,ind2]=NA
