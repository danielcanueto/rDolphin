...
fitting_prep_3 = function(Xdata,Ydata,initial_fit_parameters,program_parameters,created_baseline,limits_intensity) {
  ...
  if (BGSigNum>0) {
    ...
    BG_width=max(min(initial_fit_parameters$widths)*program_parameters$BG_width_factor,program_parameters$BG_width)
