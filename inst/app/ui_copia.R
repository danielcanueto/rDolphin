  ...
  tabsetPanel(selected="Data Upload and Processing", id='mynavlist',
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          fileInput("file2", "Reanudate a saved profiling session",
            accept = c("text/RData")),
          shinySaveButton("save", "Save profiling session", "Save session as...", filetype=list(RData="RData")),
    ...
    tabPanel("Individual Quantification",
      ...
      sidebarLayout(
        ...
        sidebarPanel(
		selectInput("quant_options",label="Select a possibility",choices=c('Analysis of exemplars'=1,'Run STOCSY'=2),selected=1),
