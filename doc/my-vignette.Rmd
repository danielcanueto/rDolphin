...
imported_data=import_data("Parameters_MTBLS242_15spectra_5groups.CSV file")
```
...
```
Go to the `output_info` folder stored inside the `extdata` folder mentioned in `Import of necessary data`. You can see some CSV file files with that contain the information of `finaloutput`.
